...
public class ClientService {
	...
	public Client fromForm(ClientForm form) {
		return new Client(form.getName(), form.getCpf(), form.getPhoneNumber());
	}
	
	public ClientDTO fromClient(Client client) {
		return new ClientDTO(client.getId(), client.getName(), client.getCpf(), client.getPhoneNumber(), client.getCreatedAt());
	}
}
